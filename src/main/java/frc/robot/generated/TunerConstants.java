...
public class TunerConstants {
    ...
    private static final Current kSlipCurrent = Amps.of(40);//previously 120   60 brownout bad
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration().withCurrentLimits(
        new CurrentLimitsConfigs().withSupplyCurrentLimit(55).withSupplyCurrentLimitEnable(true)        //current limit did not used to be on drive
    );
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(60))//used to be 60
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(3);// previously 4.58
